...
package org.apache.synapse.transport.netty.passthru.util;
...
import org.apache.synapse.transport.netty.passthru.Pipe;
import org.apache.synapse.transport.netty.passthru.config.PassThroughConfiguration;
/////////////////////////////////////////////////
/////////////////////////////////////////////////
...
public class RelayUtils {
    ...
    static {
        if (forcePTBuild == null) {
            forcePTBuild = PassThroughConfiguration.getInstance().getBooleanProperty(
                    org.apache.synapse.transport.netty.passthru.Constants.FORCE_PASSTHROUGH_BUILDER);
            if (forcePTBuild == null) {
                forcePTBuild = true;
            }
    ...
    public static void buildMessage(MessageContext messageContext, boolean earlyBuild)
        ...
        final Pipe pipe = (Pipe) messageContext.getProperty(org.apache.synapse.transport.netty.passthru.Constants.PIPE);

        if (messageContext.getProperty(org.apache.axis2.Constants.Configuration.CONTENT_TYPE) != null) {
            if (log.isDebugEnabled()) {
                log.debug("Content Type is " + messageContext.getProperty(org.apache.axis2.Constants.Configuration.CONTENT_TYPE));
            }

            if (pipe != null
                && !Boolean.TRUE.equals(messageContext
                                                .getProperty(org.apache.synapse.transport.netty.passthru.Constants.MESSAGE_BUILDER_INVOKED)) && forcePTBuild) {
                ...
                if (http_sc != null && http_sc instanceof Integer && http_sc.equals(202)) {
                    messageContext.setProperty(org.apache.synapse.transport.netty.passthru.Constants.MESSAGE_BUILDER_INVOKED,
                                               Boolean.TRUE);
                    return;
                }
    ...
    public static void builldMessage(MessageContext messageContext, boolean earlyBuild,
        ...
        BufferedInputStream bufferedInputStream = (BufferedInputStream) messageContext
                .getProperty(org.apache.synapse.transport.netty.passthru.Constants.BUFFERED_INPUT_STREAM);
        if (bufferedInputStream != null) {
            ...
            messageContext.setProperty(org.apache.synapse.transport.netty.passthru.Constants.BUFFERED_INPUT_STREAM,
                    bufferedInputStream);
        }
        ...
        try {
            ...
            */
            ...
            messageContext.setProperty(org.apache.synapse.transport.netty.passthru.Constants.MESSAGE_BUILDER_INVOKED, Boolean.TRUE);
        ...
        if (element != null) {
            ...
            earlyBuild = messageContext.getProperty(org.apache.synapse.transport.netty.passthru.Constants.RELAY_EARLY_BUILD) != null ? (Boolean) messageContext
                    .getProperty(org.apache.synapse.transport.netty.passthru.Constants.RELAY_EARLY_BUILD) : earlyBuild;
    ...
    private static Boolean getDisableAck(MessageContext msgContext) throws AxisFault {
        ...
        Boolean disableAck = (Boolean) msgContext
                .getProperty(org.apache.axis2.Constants.Configuration.DISABLE_RESPONSE_ACK);
        if (disableAck == null) {
            disableAck = (Boolean) (msgContext.getAxisService() != null ? msgContext
                    .getAxisService().getParameterValue(
                            org.apache.axis2.Constants.Configuration.DISABLE_RESPONSE_ACK) : null);
        }
